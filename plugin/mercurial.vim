...
"" \b	Branch origin	 Open a new diff window showing current branch's original revision (the first that is tagged with the current branch)
"" \B		 Close the diff window opened with \b
...
"    echomsg $HELP_MESSAGE
  ...
  echomsg '\b   Branch origin    Open a new diff window showing original revision of the current branch (the first that is tagged with the current branch)'
  echomsg '\B                    Close the diff window opened with \b'
  echomsg '\n   Newest release   Open a new diff window showing the latest closed release revision (the latest tag named release_YYYYMMDD_finished)'
